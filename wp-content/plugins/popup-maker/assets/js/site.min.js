...
function(i, t) {
    ...
    PUM_Accessibility = {
        ...
        initiateFocusLock: function() {
            var e = PUM.getPopup(this),
                o = i(":focus");
            e.has(o).length || (r = o), s = e.on("keydown.pum_accessibility", PUM_Accessibility.trapTabKey).attr("aria-hidden", "false"), (n = i('body > *:not([aria-hidden="true"])').filter(":visible").not(s)).attr("aria-hidden", "true"), i(t).one("focusin.pum_accessibility", PUM_Accessibility.forceFocus), PUM_Accessibility.setFocusToFirstItem()
        }
